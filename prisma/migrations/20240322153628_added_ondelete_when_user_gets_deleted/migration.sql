...
-- DropForeignKey
ALTER TABLE `MindscapeMeme` DROP FOREIGN KEY `MindscapeMeme_memeId_fkey`;
...
-- AddForeignKey
ALTER TABLE `MindscapeMeme` ADD CONSTRAINT `MindscapeMeme_memeId_fkey` FOREIGN KEY (`memeId`) REFERENCES `Meme`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
